...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .requestMatchers(HttpMethod.GET, "/api/customers/**").hasAuthority(ADMIN_READ.name(), USER_READ.name())
                .requestMatchers(HttpMethod.POST, "/api/customers/**").hasAuthority(ADMIN_CREATE.name(), USER_CREATE.name())
                .requestMatchers(HttpMethod.PUT, "/api/customers/**").hasAuthority(ADMIN_UPDATE.name(), USER_UPDATE.name())
                .requestMatchers(HttpMethod.DELETE, "/api/customers/**").hasAuthority(ADMIN_DELETE.name(), USER_DELETE.name())
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
